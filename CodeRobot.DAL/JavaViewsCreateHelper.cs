...
namespace CodeRobot.DAL
{
    ...
    /// Java 新增类
    /// </summary>
    public class JavaViewsCreateHelper
    {
        ...
        public static void CreateViewCreateClass(string strFilePath,string strProjectName,string strHtmlInputList, string strTableName,string strTableComment)
        {
            //读取版权信息
            ...
            StreamWriter sw = new StreamWriter(strNewPath + "\\Create.html", false, Encoding.GetEncoding("utf-8"));

            sw.WriteLine("<!DOCTYPE html>");
            sw.WriteLine("<html>");
            sw.WriteLine("<head>");
            sw.WriteLine("<meta charset=\"utf-8\">");
            sw.WriteLine("<title>新增"+strTableComment+"</title>");
