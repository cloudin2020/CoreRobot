...
namespace CodeRobot.DAL
{
    ...
    public class ViewMutiEditHelper
    {
        ...
        public static void CreateViewMutiEditClass(string strFilePath,string strProjectName, string strTableName,string strTableComment)
        {
            //读取版权信息
            ...
            sw.WriteLine("            <input type=\"hidden\" name=\"" + GetSwitchStatusKey(strTableName) + "\" id=\"" + GetSwitchStatusKey(strTableName) + "\" value=\"true\" />");
            ...
            sw.WriteLine("                    //}");
            sw.WriteLine("                    layedit.setContent(index, res.data.news_content);//会报错，但不影响使用");
